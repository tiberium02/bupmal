		...
		private function elespare_search_content_style_options(){
			...
			$this->add_control(
				...
				array(
					...
					'default'=>'#fff',
					'selectors' => array(
						'{{WRAPPER}} .elespare-search-form-header .elespare--search-sidebar-wrapper' => 'background-color: {{VALUE}}',
						'{{WRAPPER}} .elespare-search-dropdown-toggle .elespare-search--toggle-dropdown' => 'background-color: {{VALUE}}',
					),
				)
			);
			$this->add_control(
				'form_padding',
				array(
					'label'      => esc_html__( 'Form Padding', 'elespare' ),
					'type'       => Controls_Manager::DIMENSIONS,
					'size_units' => array( 'px' ),
					'selectors'  => array(
						'{{WRAPPER}} .elespare-search-form-header .elespare--search-sidebar-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						'{{WRAPPER}} .elespare-search-dropdown-toggle .elespare-search--toggle-dropdown' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					),
					'condition' => array(
						'layout' => 'form',
					),
			...
			$this->add_control(
				...
				array(
					...
					'selectors'  => array(
						...
						'{{WRAPPER}} .elespare-search--toggle-dropdown' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					),
				)
			);
		...
		private function elespare_inner_search_text_style_options(){
			...
			$this->add_group_control(
				...
				array(
					...
					'selector' => '{{WRAPPER}} .btn-elespare-search-form',
				)
			);
			$this->end_controls_section();
		}
