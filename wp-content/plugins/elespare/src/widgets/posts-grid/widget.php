    ...
    private function posts_grid_style_title_options(){
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elespare-grid-wrap.has-background .elespare-posts-wrap.elespare-light:not(.grid-style-11) .elespare-posts-grid-post-items' => 'background-color: {{VALUE}};',
                    ...
                    '{{WRAPPER}} .elespare-grid-wrap.has-background .elespare-posts-wrap.elespare-light.grid-style-11 .elespare-posts-grid-post-items .elespare-content-wrapper' => 'background-color: {{VALUE}};',
                    '{{WRAPPER}} .elespare-grid-wrap.has-background .elespare-posts-wrap.elespare-light.grid-style-12 .elespare-posts-grid-post-items ' => 'background-color: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elespare-grid-wrap.has-background .elespare-posts-wrap.elespare-dark:not(.grid-style-11) .elespare-posts-grid-post-items' => 'background-color: {{VALUE}};',
                    ...
                    '{{WRAPPER}} .elespare-grid-wrap.has-background .elespare-posts-wrap.elespare-dark.grid-style-11 .elespare-posts-grid-post-items .elespare-content-wrapper' => 'background-color: {{VALUE}};',
                    '{{WRAPPER}} .elespare-grid-wrap.has-background .elespare-posts-wrap.elespare-dark.grid-style-12 .elespare-posts-grid-post-items ' => 'background-color: {{VALUE}};',
    ...
    private function posts_grid_style_category_options(){
        ...
        $this->add_control(
            ...
            [
                ...
                'condition'=>[
                    'layout_posts_style!'=>['grid-style-5','grid-style-6'],
                ]
            ]
        );
