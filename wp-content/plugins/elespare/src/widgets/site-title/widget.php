...
class SiteTitle extends Widget_Base {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'small'   => esc_html__( 'Small', 'elespare' ),
					'medium'  => esc_html__( 'Medium', 'elespare' ),
					'large'   => esc_html__( 'Large', 'elespare' ),
					'xl'      => esc_html__( 'XL', 'elespare' ),
					'xxl'     => esc_html__( 'XXL', 'elespare' ),
				],
			]
		);
	...
	protected function register_heading_typo_content_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .elementor-heading-title, {{WRAPPER}} .elespare-heading a',
			]
		);
		$this->add_control(
			'heading_color',
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .elespare-icon i'       => 'color: {{VALUE}};',
					'{{WRAPPER}} .elespare-icon svg'     => 'fill: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		<div class="elespare-module-content elespare-heading-wrapper elementor-widget-heading">
			...
			<<?php echo esc_attr($heading_size_tag); ?> class="elespare-heading elementor-heading-title elementor-size-<?php echo esc_attr($settings['size']); ?>">
