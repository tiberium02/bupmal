	...
	protected function register_submenu_style() {
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .elespare-menu .menu-item-has-children .sub-menu a, {{WRAPPER}} .elespare-nav-default .menu-item-has-children .sub-menu-default a',
				'selector' => '{{WRAPPER}} .elespare-menu .page_item_has_children .children a',
			)
		);
