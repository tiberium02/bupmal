...
class PostFlash extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Posts Flash', 'elespare' );
    }
   ...
   */
    private function posts_flash_section_title_options(){
        ...
        $this->add_control(
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .elespare-flash-wrap .elespare-flash-side a:hover .elespare-post-title'       => 'color: {{VALUE}};',
                ),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elespare-flash-wrap.flash-style-2 .elespare-exclusive-now .elespare-exclusive-now-txt-animation-wrap:after' => 'border-left-color: {{VALUE}};',
                    '{{WRAPPER}} .elespare-flash-wrap.flash-style-3 .elespare-exclusive-now .elespare-exclusive-now-txt-animation-wrap:after' => 'background-color: {{VALUE}};',
                    '{{WRAPPER}} .elespare-flash-wrap.flash-style-4 .elespare-exclusive-now .elespare-exclusive-now-txt-animation-wrap:after' => 'background-color: {{VALUE}};',
    ...
    protected function render($instance = []) {
        ...
        $this->add_render_attribute('marquee','data-direction','left');
