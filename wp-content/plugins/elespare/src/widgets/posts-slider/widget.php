    ...
    private function posts_slider_style_title_options(){
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elespare-slider-wrap .elespare-posts-wrap:not(.slider-style-6):not(.slider-style-7)' => 'border-radius: {{SIZE}}{{UNIT}}',
        ...
        $this->add_group_control(
            ...
            [
                ...
                {{WRAPPER}} .elespare-posts-wrap.slider-style-7 .elespare-posts-slider-post-items .elespare-content-wrapper-inner',
            ]
        );
    ...
    private function posts_slider_style_meta_options(){
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px' ],
                'selectors'  => [
                    '{{WRAPPER}} .elespare-slider-wrap .elespare-posts-wrap .elespare-posts-slider-post-items .elespare-posts-slider-post-author' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
                        ...
                        while ( $all_posts->have_posts() ) : $all_posts->the_post();?>
                            ...
                            <div class="elespare-img-wrapper">
                                ...
                                if('gravatar'==$settings['author_icon_options']){
                                    if($layouts =='slider-style-d' || $layouts =='slider-style-2' || $layouts =='slider-style-3' || $layouts =='slider-style-5'){
            ...
            <div class="elespare-metadata">
                <?php if('yes'== $meta_author){
                    ...
                    <a href="<?php echo esc_url($author_link);?>">
                        ...
                        if($settings['layout_posts_style'] =='slider-style-1' || $settings['layout_posts_style'] =='slider-style-6'|| $settings['layout_posts_style'] =='slider-style-7'){
                        $author_avatar= elespare_get_user_profile_avatar(get_the_ID());?>
                                        <div class="elespare-avatar-wrap">
                                            <img src="<?php echo esc_url($author_avatar);?>">
                                        </div>
