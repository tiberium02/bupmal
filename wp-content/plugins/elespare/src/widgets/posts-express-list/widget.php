    ...
    private function posts_express_style_meta_options(){
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elespare-express-list-wrap .elespare-posts-wrap.express-style-3 .elespare-posts-express-post-items:first-child .elespare-metadata span > a' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .elespare-express-list-wrap .elespare-posts-wrap.express-style-3 .elespare-posts-express-post-items:first-child .elespare-metadata span svg' => 'fill: {{VALUE}};',
                    '{{WRAPPER}} .elespare-express-list-wrap .elespare-posts-wrap.express-style-3 .elespare-posts-express-post-items:first-child .elespare-metadata .comment_count' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .elespare-express-list-wrap .elespare-posts-wrap.express-style-4 .elespare-posts-express-post-items:nth-child(1) .elespare-metadata span > a' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .elespare-express-list-wrap .elespare-posts-wrap.express-style-4 .elespare-posts-express-post-items:nth-child(1) .elespare-metadata span svg' => 'fill: {{VALUE}};',
                    '{{WRAPPER}} .elespare-express-list-wrap .elespare-posts-wrap.express-style-4 .elespare-posts-express-post-items:nth-child(1) .elespare-metadata .comment_count' => 'color: {{VALUE}};',
                ...
                'condition'=>[
                    'layout_posts_style!'=>['express-style-1','express-style-2'],
                    'dark_mode!'=>'yes'
                        ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elespare-express-list-wrap .elespare-posts-wrap.elespare-dark.express-style-3 .elespare-posts-express-post-items:first-child .elespare-metadata span > a' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .elespare-express-list-wrap .elespare-posts-wrap.elespare-dark.express-style-3 .elespare-posts-express-post-items:first-child .elespare-metadata span svg' => 'fill: {{VALUE}};',
                    '{{WRAPPER}} .elespare-express-list-wrap .elespare-posts-wrap.elespare-dark.express-style-3 .elespare-posts-express-post-items:first-child .elespare-metadata .comment_count' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .elespare-express-list-wrap .elespare-posts-wrap.elespare-dark.express-style-4 .elespare-posts-express-post-items:nth-child(1) .elespare-metadata span > a' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .elespare-express-list-wrap .elespare-posts-wrap.elespare-dark.express-style-4 .elespare-posts-express-post-items:nth-child(1) .elespare-metadata span svg' => 'fill: {{VALUE}};',
                    '{{WRAPPER}} .elespare-express-list-wrap .elespare-posts-wrap.elespare-dark.express-style-4 .elespare-posts-express-post-items:nth-child(1) .elespare-metadata .comment_count' => 'color: {{VALUE}};',
                ...
                <?php if('yes'== $meta_author){
                    ...
                    <a href="<?php echo esc_url($author_link);?>">
                        ...
                        if('icon'==$settings['author_icon_options']) {?>
                           <i class="demo-icon elespare-icons-user-o" aria-hidden="true"></i>
                        <?php }
                        ?>
                         <?php the_author(); ?>
                    </a>
