<?php
/**
 * Elespare - News Magazine and Blog Elements Addons for Elementor
 *
 * @package Elespare
 *
 * Plugin Name: Elespare
 * Description: Free News Magazine and Blog Elements Addons for Elementor
