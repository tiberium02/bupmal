...
class Widgets {
    ...
    public function register_widgets() {
        ...
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\SiteLogo() );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\SiteTitle() );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\SiteTagline() );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\Site_Search() );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\NavigationHorizontalMenu() );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\PostBannerOne() );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\PostExpressList() );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\PostGrid() );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\PostTile() );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\PostList() );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\PostSingleColumn() );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\PostSlider() );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\Author() );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\PostFlash() );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\SocialLinks() );
